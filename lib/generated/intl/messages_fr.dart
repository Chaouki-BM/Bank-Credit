...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "SplashT2": MessageLookupByLibrary.simpleMessage(
      "Accès instantané au crédit",
    ),
    "SplashT3": MessageLookupByLibrary.simpleMessage(
      "Sécurisé. Fiable. Toujours avec vous.",
    ),
    "SsubT1": MessageLookupByLibrary.simpleMessage(
      "Gérez votre argent, crédit et avenir — le tout dans une application sécurisée.",
    ),
    "SsubT2": MessageLookupByLibrary.simpleMessage(
      "Demandez des prêts, gérez vos cartes de crédit et suivez vos limites en temps réel.",
    ),
